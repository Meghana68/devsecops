...
node {
	...
	stage ('Fortify On Demand Scan')
	    ...
	    sh """ java -jar "FodUpload.jar" -ac 84d31df7-cb06-432b-818f-2bc63515c39c RWJiMXNnalQyY0R4dUJ5aUY4elwpWkw5ezBrS0Vl -rid 656 -purl https://sandbox.fortify.com/ -apiurl https://api.sandbox.fortify.com/ -z "WebGoat-develop.zip" -ep 2 -rp 0 -pp 2 """
          }
        }
